...
import no.digdir.informasjonsforvaltning.fdk_dataservice_harvester.utils.ApiTestContainer.Companion.fusekiContainer
...
val DATASERVICE_ID_0 = "ea51178e-f843-3025-98c5-7d02ce887f90"
val DATASERVICE_ID_1 = "4d69ecde-f1e8-3f28-8565-360746e8b5ef"
val CATALOG_ID_0 = "e422e2a7-287f-349f-876a-dc3541676f21"
val CATALOG_ID_1 = "65555cdb-6809-3cc4-bff1-aaa6d9426311"

fun getApiAddress(endpoint: String): String {
    return "http://${TEST_API.containerIpAddress}:${TEST_API.getMappedPort(API_PORT)}$endpoint"
}

fun getFusekiAddress(endpoint: String): String {
    return "http://${fusekiContainer.containerIpAddress}:${fusekiContainer.getMappedPort(API_PORT)}/fuseki/$endpoint"
}