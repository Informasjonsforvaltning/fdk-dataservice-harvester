...
public class DsopEndpointSearchControllerTest {

    ApiDocumentRepository apiDocumentRepository;

    private DsopEndpointSearchController controller;

    @Before
    public void setup() {
        apiDocumentRepository = mock(ApiDocumentRepository.class);
        controller = new DsopEndpointSearchController(apiDocumentRepository);
    }
