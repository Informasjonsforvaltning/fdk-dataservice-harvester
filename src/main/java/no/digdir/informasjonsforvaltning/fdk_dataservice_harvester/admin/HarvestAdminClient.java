package no.digdir.informasjonsforvaltning.fdk_dataservice_harvester.admin;
...
public class HarvestAdminClient {
    ...
    public List<HarvestDataSource> getDataSources() {
        return this.getDataSources(new LinkedMultiValueMap<>());
    }

    public List<HarvestDataSource> getDataSources(MultiValueMap<String, String> queryParams) {
