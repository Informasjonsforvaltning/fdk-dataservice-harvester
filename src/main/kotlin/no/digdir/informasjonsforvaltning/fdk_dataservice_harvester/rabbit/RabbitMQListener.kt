...
import no.digdir.informasjonsforvaltning.fdk_dataservice_harvester.model.RabbitHarvestTrigger
...
class RabbitMQListener(
    ...
    fun receiveDataServiceHarvestTrigger(body: RabbitHarvestTrigger, message: Message) {
